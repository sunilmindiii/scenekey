<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="#">All Builders</a></li>
    </ul>

    <div class="row-fluid sortable">		
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon star"></i><span class="break"></span>All Builders</h2>
                <div class="box-icon">
                    <a href="<?php echo base_url(); ?>admin/frontusers/addNewFrontUser/?type=<?php echo $this->cm->idEncrypt(2); ?>">
                        <button class="add-btn btn-primary">Add New</button>
                    </a>
            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                        <?php
                        if (!empty($this->data['allFrontUsersRecords'])) {
                            $i = 1;
                            foreach ($this->data['allFrontUsersRecords'] as $row) {
                                ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <?php } else { ?>
                                            <img src="<?php echo base_url(); ?>uploads/users/<?php echo $row->user_image; ?>" height="50" width="50">
                                        <?php } ?>
                                    </td>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>admin/frontusers/viewBuilderUserFullDetail/<?php echo $this->cm->idEncrypt($row->user_id); ?>">
                                            <i class="halflings-icon white zoom-in" title="Full Detail"></i>  
                                        </a>
                                        <a class="btn btn-info" href="<?php echo base_url(); ?>admin/frontusers/updateFrontUserDetails/<?php echo $this->cm->idEncrypt($row->user_id); ?>/?type=<?php echo $this->cm->idEncrypt(5); ?>">
