    ...
    <div class="row-fluid sortable">		
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon star"></i><span class="break"></span>All Brokers</h2>
                <div class="box-icon">
                        ...
                        if (!empty($this->data['allFrontUsersRecords'])) {
                            ...
                            foreach ($this->data['allFrontUsersRecords'] as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-success" href="<?php echo base_url(); ?>admin/frontusers/viewBrokerUserFullDetails/<?php echo $this->cm->idEncrypt($row->user_id); ?>">
                                            <i class="halflings-icon white zoom-in" title="Full Detail"></i>  
                                        </a>
                                        <a class="btn btn-info" href="<?php echo base_url(); ?>admin/frontusers/updateFrontUserDetails/<?php echo $this->cm->idEncrypt($row->user_id); ?>/?type=<?php echo $this->cm->idEncrypt(4); ?>">
