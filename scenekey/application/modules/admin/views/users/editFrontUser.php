                ...
                <form class="form-horizontal" method="post" parsley-validate>
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="input-xlarge focused" id="focusedInput" name="aboutUser" value="<?php echo $userRecord->user_about; ?>" /></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge focused" id="focusedInput" name="userOrganisation" value="<?php echo $userRecord->user_organisation; ?>" /></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge focused" id="focusedInput" name="userDesignation" value="<?php echo $userRecord->user_designation; ?>" ></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="url" class="input-xlarge focused" id="focusedInput" name="userSite" value="<?php echo $userRecord->user_website; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="input-xlarge focused" id="focusedInput" name="userAddress" value="<?php echo $userRecord->user_address; ?>" ></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge focused" id="focusedInput" name="userAddressZIP" value="<?php echo $userRecord->user_address_zip; ?>" >                           </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <a href="<?php echo base_url(); ?>admin/frontusers/ChangePassword/<?php echo $this->cm->idEncrypt($userRecord->user_id);?>/?type=<?php echo $this->cm->idEncrypt($userRecord->user_type_id); ?>" class="btn">Change Password</a>
                            </div>
                        </div>
