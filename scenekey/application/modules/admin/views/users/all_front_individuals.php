<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="#">All Individuals Users</a></li>
    </ul>

    <div class="row-fluid sortable">		
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon star"></i><span class="break"></span>All Individuals Users</h2>
                <div class="box-icon">
                            ...
                            foreach ($this->data['allFrontUsersRecords'] as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-info" href="<?php echo base_url(); ?>admin/frontusers/updateFrontUserDetails/<?php echo $this->cm->idEncrypt($row->user_id); ?>/?type=<?php echo $this->cm->idEncrypt(3); ?>">
